...
@section('content')
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-teal-500 rounded-2xl p-6 shadow text-white">
            ...
            <p class="opacity-80 mt-1">اختر اسم الدور والصلاحيات الخاصة به</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-6">
            ...
            <!-- اسم الدور -->
               ...
               focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                ...
                <!-- الصلاحيات -->
                <div class="mb-6">
                    <label class="block mb-4 font-semibold text-gray-700 dark:text-gray-200">
                        الصلاحيات
                    </label>
                ...
                <button
                    type="submit"
                    class="bg-gradient-to-r from-blue-600 to-teal-500 text-white px-6 py-2 rounded-xl
                       shadow hover:from-blue-700 hover:to-teal-600 transition"
                >
                    💾 حفظ الدور
                </button>
            </form>
