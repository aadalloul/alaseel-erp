...
@section('header-button')
    <a href="#" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full shadow-lg">
...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-gray-50 rounded-2xl shadow-lg p-6 flex justify-between items-center">
            <div>
                <h3 class="text-gray-500 text-sm">متاحة</h3>
                <p class="text-2xl font-bold">{{ $availableProducts }}</p>
            </div>
            <i class="fa fa-check-circle text-green-600 text-4xl"></i>
        </div>
        <div class="bg-gray-50 rounded-2xl shadow-lg p-6 flex justify-between items-center">
            <div>
                <h3 class="text-gray-500 text-sm">منتهية</h3>
                <p class="text-2xl font-bold">{{ $expiredProducts }}</p>
            </div>
            ...
            @foreach ($products as $product)
                <tr class="border-b hover:bg-gray-50 transition">
                    ...
                    <td class="p-4 flex gap-2">
                        <a href="#" class="px-3 py-1 bg-yellow-400 text-white rounded hover:bg-yellow-500 transition">
                            <i class="fa fa-edit"></i> تعديل
                        </a>
                        <a href="#" class="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 transition">
